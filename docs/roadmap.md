...
Ideas that are not built yet. Open roadmap work is tracked as GitHub issues, for example [#153](https://github.com/Danathar/goodreads-mcp/issues/153) (publishing to PyPI, `uvx`, and the MCP registry).
